...
for k = 1:4 % On récupère le facteur de qualité
    ...
    xlim([150e3,300e3]) % Intervalle pour la fréquence
end

xlabel('Frequence (Hz)') % Axes 
ylabel('Facteur de qualité Q')
grid on % Grille en fond 
%% Remarque : L'impact du filtre mal réglé se fait ressentir (---> Importance de bien choisir son filtre)
