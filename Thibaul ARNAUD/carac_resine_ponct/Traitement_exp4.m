...
for k = 1:4 % On récupère le facteur de qualité
    ...
    xlim([200e3,300e3]) % Intervalle pour la fréquence
end
...
title('Valeurs moyennes de la vitesse de groupe');
xlabel('Frequence (Hz)'); %Axes
ylabel('Vitesse (m/s)');
grid on ;
box on;
...
xlim([200e3,300e3]);
legend('Zone Min-Max', 'Min', 'Moyenne', 'Max');
title('Valeurs moyennes du facteur de qualité');
xlabel('Frequence (Hz)'); %Axes
