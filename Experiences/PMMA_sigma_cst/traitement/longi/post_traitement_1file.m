% Post traitement pour relire et réafficher les donnée
...
%% bac a sable de test 
[~,ax1] = plot_post_traitement("window_str_rect__fc_0p8.mat", ...
    "bool_xlim",bool_xlim,"delta_f_affichage",delta_f_affichage,titre="0.5Mhz");
...
%% Tout ce script a été mis dans la fonction plot_post_traitement
% % load des data prétraité  
% data = load("window_str_rect__fc_0p5.mat");
% data = data.data2save;
% 
% data.data
