...
name_c1 = namebase+"longi_fc_0p6.mat";%0.5 ok
name_c2 = namebase+"longi_fc_0p6.mat"; %ù si je n'ai pas deux qualibre je met deux fois le meme calibre ca change rien
fc = 0.6e6;
...
if plot_res
    ...
    errorbar(real_fc, vs_temp2vol, err_vs, err_vs, 0, 0, ...
        'LineStyle','none', ...
        'Marker','+', ...
        'MarkerSize',12, ...
