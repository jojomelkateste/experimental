name_base = "C:\Users\melka\Desktop\experimental_reprise\MesManip\PMMA_reflexion_MHZ_sigmat_cst\traitement\";
...
h_mean = plot(freq, vg_array, 'LineWidth', 2, 'Color', 'b', 'DisplayName', 'Moyenne S(x)');
% 
plot(freq,min_vg_array,"r--",'DisplayName', 'minimum')
plot(freq,max_vg_array,"r--",'DisplayName', 'maximum')
...
scatter(fc_values, temps2vol, 100, "+" ,'DisplayName', 'Par temps de vol moyen', 'LineWidth', 2)
...
f = figure;
hold on;
title('Partie imaginaire de k avec écart Min/Max');
xlabel('f [Hz]');
ylabel('Im(k)');
% Trace la ligne de la moyenne
plot(freq, imK_array, 'LineWidth', 2, 'Color', 'b', 'DisplayName', 'Moyenne Im(k)');
% 
plot(freq, min_imK_array, "r--", 'DisplayName', 'minimum')
plot(freq, max_imK_array, "r--", 'DisplayName', 'maximum')
...
fc_values = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5] * 1e6;
scatter(fc_values, kpp_values, 100, "+", 'DisplayName', 'kpp', 'LineWidth', 2)
legend();
...
f = figure;
hold on;
title('Facteur de qualité Q avec écart Min/Max');
xlabel('f [Hz]');
ylabel('Q');
% Trace la ligne de la moyenne
plot(freq, Q_array, 'LineWidth', 2, 'Color', 'b', 'DisplayName', 'Moyenne Q');
% 
plot(freq, min_Q_array, "r--", 'DisplayName', 'minimum')
plot(freq, max_Q_array, "r--", 'DisplayName', 'maximum')
