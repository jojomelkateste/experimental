...
disp("Pas encore finit")
%path = "C:\Users\melka\Desktop\experimental_reprise\MesManip\Epoxy_MegaHz\";
path = "C:\Users\Utilisateur\Desktop\Experimental\autreetancien\experimental_reprise\MesManip\Epoxy_MegaHz\"
name1 = path+"Epoxy_l39mm_1Mhz.mat";
name2 = path+"Epoxy_l39mm_1Mhz_dezoom.mat";
fc = 1e6;
e = 0.039;

% A modifier si on a pas tout les pics
MinPeakHeight = 0.04;% defaut 0.05
MinPeakDistance = 200;%defaut 200 

Szoom= load(name1);
S1  = load(name2);

disp("Creer une fonction qui prend tout les pics")
[data_traite] = traitement_2source_2calibre(S1,Szoom,e,fc, MinPeakHeight,MinPeakDistance);


src1 = S1.src1; % emeteur
src2 = S1.src2; % recepteur 

src2.Data(1:34200) = 0; % j enleve le pic etrange du début

% On fait le traitement
[data_traite_2] = traitement_automatique(src2,e,fc,MinPeakHeight,MinPeakDistance); 
