% issue de ma nouvelle facon de faire
close all;
plot_pulses=false;
plot_res = true;
window_str = "rect";
...
namebase = "C:\Users\Utilisateur\Desktop\Experimental\autreetancien\experimental_reprise\MesManip\Epoxy_MegaHz\";
name_c1 = namebase+"Epoxy_l39mm_1Mhz_dezoom.mat";%0.5 ok
name_c2 = namebase+"Epoxy_l39mm_1Mhz.mat"; %ù si je n'ai pas deux qualibre je met deux fois le meme calibre ca change rien
fc = 1.0e6;
...
MinPeakDistance =  5000; % pas en indices pour la distence minimum pour comencer
MinPeakHeight1  = 2e-2;
MinPeakHeight2  = 2e-4;
