%% Ce fichier on peut le transformer comme on veut peut faire des testes



name1 = "Epoxy_l49mm_1Mhz.mat";
...
d = 2*49*1e-3; % entre un pic et un autre l onde a fait un alle retour
