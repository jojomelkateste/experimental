...
clear all
close all
e = 0.042; % etre plus precis plus tard
d = 2*e;
fc = 1e6;
omega = fc*2*pi;
...
file1 = "20251201_essai003_1Mhz.mat"; % dezoom
file2 = "20251201_essai002_1Mhz.mat"; % zoom
...
MinPeakHeight = 0.01;%max(uz_r_clean)/30;%0.004
